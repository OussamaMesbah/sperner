"""Split the rent fairly: the flagship application of Sperner's lemma.
...
from webapp.common import REPOSITORY, footer
...
def main() -> None:
    ...
    with st.expander("How does this work?"):
        ...
        st.page_link("webapp/sperner_lemma.py", label="The lemma, with the proof", icon="🎨")
