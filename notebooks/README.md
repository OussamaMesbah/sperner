...
| Notebook | Topic |
|---|---|
| [01_sperners_lemma](01_sperners_lemma.ipynb) | Colourings, the odd count, the walk through doors |
| [02_fair_rent](02_fair_rent.ipynb) | Envy-free rent with simulated flatmates, one question at a time |
| [03_brouwer_and_hex](03_brouwer_and_hex.ipynb) | Fixed points, the Hex theorem and Gale's proof of Brouwer's theorem |
| [04_nash_equilibria](04_nash_equilibria.ipynb) | Nash's map, the hawk–dove game, two-player games |
